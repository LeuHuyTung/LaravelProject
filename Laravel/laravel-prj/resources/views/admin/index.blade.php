                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span class="avatar-title bg-danger-subtle rounded-circle">
                                                                        <img src="{{asset('images/products/logo/logo-6.svg')}}" alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-md flex-shrink-0 me-2">
                                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                                        <img src="{{asset('images/products/logo/logo-8.svg')}}" alt="" height="22">
                                                                    </span>
                                                                </div>
                                                                <div>
                                            ...
                                            <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="{{asset('images/products/p-1.png')}}" alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="{{asset('images/products/p-7.png')}}" alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="{{asset('images/products/p-4.png')}}" alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="{{asset('images/products/p-5.png')}}" alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-lg">
                                                                <img src="{{asset('images/products/p-6.png')}}" alt="Product-1" class="img-fluid rounded-2">
                                                            </div>
                                                        </td>
                                                        <td class="ps-0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="{{asset('images/products/p-6.png')}}" alt="product-pic" height="36">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="{{asset('images/products/p-1.png')}}" alt="product-pic" height="36">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="{{asset('images/products/p-3.png')}}" alt="product-pic" height="36">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative mb-2">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="{{asset('images/products/p-4.png')}}" alt="product-pic" height="36">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center gap-2 position-relative">
                                    <div class="avatar-md flex-shrink-0">
                                        <img src="{{asset('images/products/p-2.png')}}" alt="product-pic" height="36">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="card mb-0 bg-warning bg-opacity-25">
                                    <div class="card-body" style="background-image: url(images/png/arrows.svg); background-size: contain; background-repeat: no-repeat; background-position: right bottom;">
